...
public class RobotReturnToOrigin {
	...
	/**
	 * 我自己写的方法
	 * 时间复杂度：O(n) where n is the length of moves. We iterate through the string.
	 * 空间复杂度：O(n) where n is the length of moves. We iterate through the string.
	 * @param moves
	 * @return
	 */
